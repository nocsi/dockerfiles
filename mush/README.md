# roster.nocsi.org/mush  

[`roster.nocsi.org/mush`][1] is a [docker][2] image that bundles the following:  
...
cat $(TEMPLATES_DIR)/terraform.tfvars.tmpl |  docker run -i \
	...
	roster.nocsi.org/mush:0.0.1 > $(BUILD_DIR)/terraform.tfvars
```
...
[1]: https://hub.docker.com/r/roster.nocsi.org/mush/   
[2]: https://docker.com 
[3]: https://github.com/nocsigroup/mush
