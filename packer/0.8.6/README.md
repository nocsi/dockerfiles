# roster.nocsi.org/packer  

[`roster.nocsi.org/packer`][1] is a [docker][2] image that bundles the following:  
...
docker run -it --rm \
	...
	roster.nocsi.org/packer:0.8.6 version   
...
[1]: https://hub.docker.com/r/roster.nocsi.org/packer/   
[2]: https://docker.com 
[3]: https://packer.io/  
